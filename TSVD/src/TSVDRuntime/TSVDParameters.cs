...
namespace TSVDRuntime
{
    ...
    public class TSVDParameters
    {
        ...
        /// </summary>
        private readonly Dictionary<string, Queue<InterceptionPoint>> lastInterceptionPointForOBJ = new Dictionary<string, Queue<InterceptionPoint>>();
        ...
        /// </summary>
        private readonly Dictionary<string, Dictionary<string, HashSet<Trap>>> trapPoints = new Dictionary<string, Dictionary<string, HashSet<Trap>>>();
        ...
        public void InterceptionPointStart(InterceptionPoint interceptionPoint, object instance = null, object[] parameters = null)
        {
            ...
            */
            ...
            interceptionPoint.ObjID = (threadSafetyInterceptionPoint.ThreadSafetyGroup.IsStatic ? ObjectId.GetRefId(null) : ObjectId.GetRefId(instance)).ToString();
        ...
        private Trap CheckForBugsAndStartTrap(InterceptionPoint interceptionPoint, ThreadSafetyInterceptionPoint threadSafetyInterceptionPoint, Dictionary<string, HashSet<Trap>> trapObjects, TrapPlan trapPlan, object instance, out bool bugFound)
        {
            int danger = -1;
        ...
        private Dictionary<string, HashSet<Trap>> GetTrapObjects(ThreadSafetyInterceptionPoint threadSafetyInterceptionPoint)
        {
            string groupName = threadSafetyInterceptionPoint.ThreadSafetyGroup.Name;
            Dictionary<string, HashSet<Trap>> trapObjects = null;
            lock (this.trapPoints)
            {
                if (!this.trapPoints.ContainsKey(groupName))
                {
                    this.trapPoints.Add(groupName, new Dictionary<string, HashSet<Trap>>());
                }
