...
{
    /// <summary>
    /// Class HBTrapController.
    /// Implements the <see cref="TSVDRuntime.ITrapController" />.
    /// </summary>
    /// <seealso cref="TSVDRuntime.ITrapController" />
    public class HBTrapController : ITrapController
    {
        /// <summary>
        /// The blacklist.
        /// </summary>
        ...
        private Dictionary<string, HashSet<Trap>> GetTrapObjects(string groupName)
        {
        ...
        private void RemoveDangerItem(string tpstr1, string tpstr2)
        {
            ...
            lock (this.dangerousTPPairs)
            {
                ...
                // DebugLog.Log("Remove bugs from list " + st);
            }
        }
