namespace TSVDInstrumenter
{
    ...
    public static class CecilExtensions
    {
        ...
        /// <summary>
        /// Updates instruction references within a method.
        /// </summary>
        /// <param name="method">The method definition.</param>
        /// <param name="oldInstruction">Old reference.</param>
        /// <param name="newInstruction">new reference.</param>
        /// <param name="exceptionHanldersOnly">True if references are updated within exception handlers only.</param>
        public static void UpdateInstructionReferences(this MethodDefinition method, Instruction oldInstruction, Instruction newInstruction, bool exceptionHanldersOnly = false)
        {
            ...
            {
                if (eh.TryStart == oldInstruction)
                {
                    eh.TryStart = newInstruction;
                }

                if (eh.TryEnd == oldInstruction)
                {
                    eh.TryEnd = newInstruction;
                }

                if (eh.HandlerStart == oldInstruction)
                {
                    eh.HandlerStart = newInstruction;
                }

                if (eh.HandlerEnd == oldInstruction)
                {
                    eh.HandlerEnd = newInstruction;
                }

                if (eh.FilterStart == oldInstruction)
                {
        ...
        /// <summary>
        /// Insert list of instructions after a given instruction.
        /// </summary>
        /// <param name="ilProcessor">IL Processor.</param>
        /// <param name="target">Target instruction.</param>
        /// <param name="instructionsToInsert">Instructions to insert.</param>
        ...
        /// <summary>
        /// Insert list of instructions before a given instruction.
        /// </summary>
        /// <param name="ilProcessor">IL Processor.</param>
        /// <param name="target">Target instruction.</param>
        /// <param name="instructionsToInsert">Instructions to insert.</param>
